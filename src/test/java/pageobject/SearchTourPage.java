...
/*public class SearchTourPage extends AbstractPage {
    WebDriver driver;
    ...
    @FindBy(xpath = "//img[@src='/local/images/markup-images/filters/filter-to.svg']")
    ...
    public SearchTourPage(WebDriver driver) {
        super(driver);
        PageFactory.initElements(driver, this);
    }

    public SearchTourPage chooseDeparturePointCity() {
    ...
    public SearchTourPage choosePlaceOfArrival() {
        new WebDriverWait(driver, Duration.ofSeconds(WAIT_TIMEOUT_SECONDS))
...
/*    public SearchTourPage chooseDateOfDeparture() {
        new WebDriverWait(driver, Duration.ofSeconds(WAIT_TIMEOUT_SECONDS))
    ...
    public SearchTourPage choosePeopleOfDeparture() {
        new WebDriverWait(driver, Duration.ofSeconds(WAIT_TIMEOUT_SECONDS))
    ...
    public SearchTourPage clickSearchButton() {
        buttonSearch.click();
        return this;
    }
